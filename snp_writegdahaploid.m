function [status] = snp_writegdahaploid(haplodata,filename,subpopidx)
%SNP_WRITEGDAHAPLOID - save genotype data for GDA
%
%  snp_writegdahaploid(haplodata)
%  snp_writegdahaploid(haplodata,filename,subpopidx)
...
status=0;
%[haplodata] = snp_geno2haplo(genodata);
