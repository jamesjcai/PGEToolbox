function [v, pos] = snp_slidingfunbybp(funfcn, genodata, markpos, winsize, step, varargin)
%SNP_SLIDINGFUNBYBP- Sliding windows analysis by site
%   USAGE: [v,pos] = snp_slidingfunbybp(funfcn,genodata,markpos,winsize,step,varargin)
...
if (nargin < 4), winsize = round(m./1000); end
if (nargin < 5), step = round(m./2000); end
