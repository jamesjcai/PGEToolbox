                                                                            ...
                                                                            function samplesize_Callback(hObject, eventdata, handles)
                                                                                ...
                                                                                % --- Executes on button press in run.
                                                                                    function run_Callback(hObject, eventdata, handles)
                                                                                        ...
                                                                                        if (isempty(nsam)), warndlg('Sample size must be a number.');
                                                                                            return;
                                                                                        end
                                                                                        if (isempty(nrep)), warndlg('Number of replicates must be a number.');
                                                                                            return;
                                                                                        end

                                                                                        if (nsam == 0), warndlg('Sample size cannot be zero.');
                                                                                            return;
                                                                                        end
                                                                                        if (nrep == 0), warndlg('Number of replicates cannot be zero.');
                                                                                            return;
                                                                                        end
                                                                                        ...
                                                                                        if (get(handles.norecombinationcheck, 'Value')),
                                                                                            ...
                                                                                            if (rho < 0 | rho > 500), warndlg('4Nr should between 0 - 500.');
                                                                                                return;
                                                                                            end
                                                                                            if (nsites < 2), warndlg('nsites should >=2.');
                                                                                                return;
                                                                                            end
                                                                                        end
