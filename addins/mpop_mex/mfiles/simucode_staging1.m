...
for G = 1:200
    ...
    for c = 1:4:2 * N
        ...
        if (rand > 0.5), child1gm1 = gm1;
        else child1gm1 = gm2;
        end
        if (rand > 0.5), child1gm2 = gm3;
        else child1gm2 = gm4;
        end
        if (rand > 0.5), child2gm1 = gm1;
        else child2gm1 = gm2;
        end
        if (rand > 0.5), child2gm2 = gm3;
        else child2gm2 = gm4;
        end
        ...
        if (rand > 0.5), HGb(c, :) = gm1;
        else HGb(c, :) = gm2;
        end
        if (rand > 0.5), HGb(c+1, :) = gm3;
        else HGb(c+1, :) = gm4;
        end
        if (rand > 0.5), HGb(c+2, :) = gm1;
        else HGb(c+2, :) = gm2;
        end
        if (rand > 0.5), HGb(c+3, :) = gm3;
        else HGb(c+3, :) = gm4;
        end
    end
